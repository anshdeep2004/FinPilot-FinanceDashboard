...
const MyBalance = ({ balance }) => {
    return (
        <div className="bg-white text-black p-6 rounded-2xl w-full h-44 border border-gray-300">
            ...
            <div className="flex gap-3 items-center mt-5 w-full">
                ...
                <button className="bg-white text-green-600 text-sm font-bold w-1/2 px-4 py-2 rounded-lg border border-gray-300 ml-auto hover:bg-gray-50 transition-colors duration-300">
                    Transaction
                </button>
            </div>
        </div>
