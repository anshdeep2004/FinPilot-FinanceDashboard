...
//           } min-w-175 px-6 py-3 text-sm font-semibold text-gray-600 dark:text-gray-100 border-b border-gray-300 dark:border-gray-700`}
//         >
//           <div>Date</div>
//           <div>Description</div>
//           <div>Category</div>
...
//         {transactions.slice(0, visibleRows).map((trans, index) => (
//           <div
//             key={index}
//             className={`grid ${
//               onEdit
//                 ? "grid-cols-[1.2fr_2.5fr_1.2fr_1fr_1fr_0.8fr]"
//                 : "grid-cols-[1.2fr_3fr_1.5fr_1.2fr_1.3fr]"
//             } min-w-175 px-6 py-4 items-center border-b border-gray-300 dark:border-gray-700
...
const TransactionList = ({ transactions, onEdit, onDelete }) => {
  ...
  // const isSearchActive = transactions.length === 0;
