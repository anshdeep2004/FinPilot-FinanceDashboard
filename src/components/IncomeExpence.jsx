...
const IncomeExpence = ({ inc_exp, money, inc_dec }) => {
    ...
    return (
        <div className="bg-white text-black p-6 rounded-2xl w-full border border-gray-300 h-44 max-h-44">
            <Wallet className={`${isIncome ? "text-green-600" : "text-red-600"} w-5 h-5`} size={32} />
            <p className="text-black font-medium mt-3">Monthly {inc_exp}</p>
